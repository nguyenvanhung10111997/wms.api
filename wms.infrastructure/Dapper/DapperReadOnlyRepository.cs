...
namespace wms.infrastructure
{
    public sealed class DapperReadOnlyRepository : IReadOnlyRepository
    {
        ...
        public async Task<T> StoreProcedureQueryFirstAsync<T>(string storeProcedureName, object param = null, int timeout = 60)
        {
            return await _connection.QueryFirstOrDefaultAsync<T>(storeProcedureName, param, commandType: CommandType.StoredProcedure, commandTimeout: timeout);
        }
